...
ALLOWED_HOSTS = ['**************.com', '************.com'] if PRODUCTION else ['*']
...
if PRODUCTION:
    ...
    UNIONPAY_APP_PRIVATE_KEY_CERT_PASSWORD = '***********************************' # 商户私钥证书密码
    UNIONPAY_APP_PRIVATE_KEY_CERT_FILENAME = '***********************************'
    UNIONPAY_PUBLIC_KEY_CERT_FILENAME = '***********************************'
    UNIONPAY_MER_ID = '***********************************'
    UNIONPAY_BACK_URL = '***********************************'
    UNIONPAY_FRONT_URL = '***********************************'
    UNIONPAY_PAY_URL = '***********************************'
...
if PRODUCTION:# 接收微信支付异步通知回调地址，通知url必须为直接可访问的url，不能携带参数
    ...
    WECHATPAY_NOTIFY_URL = '***********************************'
WECHATPAY_DOPAY_URL = '***********************************'# 微信统一下单接口
WECHATPAY_CHECKORDER_URL = '***********************************'# 微信订单查询接口
...
MOLPAY_NOTIFY_URL = '***********************************'
MOLPAY_DOPAY_URL = '***********************************'
MOLPAY_CHECKORDER_URL = '***********************************'
# MOL支付相关配置END

# 分期乐支付相关配置
FENQILEPAY_PARTNER_ID = '***********************************'
FENQILEPAY_SECRET = '***********************************'
FENQILEPAY_C_MERCH_ID = '1'
if PRODUCTION:
    FENQILEPAY_NOTIFY_URL = '***********************************'
else:
    FENQILEPAY_NOTIFY_URL = '***********************************'
FENQILEPAY_DOPAY_URL = '***********************************'
# 分期乐支付相关配置END
...
# 阿里大于短信服务接入相关配置信息
SMS_ALIDAYU_APPKEY = '***********************************'
SMS_ALIDAYU_APPSECRET = '***********************************'
SMS_BIND_PHONE_TEMPLATE_CODE = '***********************************'
SMS_BIND_PHONE_FREE_SIGN_NAME = '***********************************'
SMS_RESET_PASSWORD_TEMPLATE_CODE = '***********************************'
SMS_RESET_PASSWORD_FREE_SIGN_NAME = '***********************************'
...
if PRODUCTION:
    ...
    REDIS_HOST_SINGAPORE = '***********************************'
    REDIS_PORT_SINGAPORE = 6379
    REDIS_PASSWORD_SINGAPORE = '***********************************'
